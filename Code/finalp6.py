...
class ArrogantProfessor(Professor): 
    # no need to def own attribute, just inherit from Professor
    # self.name + ' says: ' + self.lecture(stuff)
    # will return to ArrogantProfessor.lecture(), not use Professor.lecture()
    def lecture(self,stuff):
